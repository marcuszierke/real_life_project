...
class CampaignsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create campaign" do
    assert_difference('Campaign.count') do
      post campaigns_url, params: { campaign: { end: @campaign.end, name: @campaign.name, start: @campaign.start } }
    end
  ...
  test "should update campaign" do
    patch campaign_url(@campaign), params: { campaign: { end: @campaign.end, name: @campaign.name, start: @campaign.start } }
