...
class PharmaciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pharmacy" do
    assert_difference('Pharmacy.count') do
      post pharmacies_url, params: { pharmacy: { city: @pharmacy.city, email: @pharmacy.email, fax: @pharmacy.fax, name: @pharmacy.name, phone: @pharmacy.phone, street: @pharmacy.street, zip: @pharmacy.zip } }
    end
  ...
  test "should update pharmacy" do
    patch pharmacy_url(@pharmacy), params: { pharmacy: { city: @pharmacy.city, email: @pharmacy.email, fax: @pharmacy.fax, name: @pharmacy.name, phone: @pharmacy.phone, street: @pharmacy.street, zip: @pharmacy.zip } }
